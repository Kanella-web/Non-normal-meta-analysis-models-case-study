...
############# FOREST PLOT FOR NORMAL-DPd-26-N(HN/Unif) MODEL #######

max_values = read.csv("C:\\Users\\Lela Panag\\Desktop\\2nd PhD article\\data\\pre_term_data58\\DPn_U_U_26_normal_base_58\\max_prob_mix.csv")  
max_indices = read.csv("C:\\Users\\Lela Panag\\Desktop\\2nd PhD article\\data\\pre_term_data58\\DPn_U_U_26_normal_base_58\\clustering_assignment_mix.csv")  

rel_eff = read.csv("C:\\Users\\Lela Panag\\Desktop\\2nd PhD article\\data\\pre_term_data58\\DPn_U_U_26_normal_base_58\\rel_eff_DPd_26_U_U_norm_mix_normal_base_pred.csv" )  
es = read.csv("C:\\Users\\Lela Panag\\Desktop\\2nd PhD article\\data\\pre_term_data58\\DPn_U_U_26_normal_base_58\\res_DPd_26_U_U_norm_mix_normal_base_same_tau_comp_pred.csv" )  
mean_cl = read.csv("C:\\Users\\Lela Panag\\Desktop\\2nd PhD article\\data\\pre_term_data58\\DPn_U_U_26_normal_base_58\\clusters_mean.csv")  
...
# cl = cat(cl_vec)
# clusters  <- c(1,  1,  2,  2,  2,  1,  2,  1,  2,  1,  2,  2,  2,  1,  2,  1,  3,  1,  "3/1",  1,  1,
#                2,  2,  "3/1",  3,  3,  1,  1,  2,  1,  1,  1, "1/2",  1,  2,  3,  2,  1,  2,  1,  1,  3,
#                2,  3,  2,  3,  1,  1, 4,  1,  3,  2,  1,  3,  2,  2,  1,  1,  1,  3,  2,  3,  1,
#                2, 1)

# Define a color palette
color_palette <- c( "black", "#b71c1c")
...
replacement_values <- c(16, 15)  # Adjust the length if needed
...
sorted_rel_eff <- sorted_data$rel_effDPd_U_U_26_norm_mix_normal_base
sorted_LB <- sorted_data$LB_rel_effDPd_U_U_26_norm_mix_normal_base
sorted_UB <- sorted_data$UB_rel_effDPd_U_U_26_norm_mix_normal_base
...
abline(v=c(mean_cl1), col = c("black"), lwd=1.5)

addpoly(x= es$mu_DPd_U_U_26_norm_mix_normal_base, ci.lb = es$LB_mu_DPd_U_U_26_norm_mix_normal_base ,
        ci.ub = es$UB_mu_DPd_U_U_26_norm_mix_normal_base , rows=-0.5)
arrows(x0 = es$LB_delta_new_DPd_U_U_26_norm_mix_normal_base,
       x1 = es$UB_delta_new_DPd_U_U_26_norm_mix_normal_base,
       y0 = -2, y1 = -2,
...
# Open TIFF device
tiff("C:\\Users\\Lela Panag\\Desktop\\2nd PhD article\\data\\pre_term_data58\\DPn_U_U_26_normal_base_58\\DPMn.tiff", 
...
addpoly(x= es$mu_DPd_U_U_26_norm_mix_normal_base, ci.lb = es$LB_mu_DPd_U_U_26_norm_mix_normal_base ,
        ci.ub = es$UB_mu_DPd_U_U_26_norm_mix_normal_base , rows=-0.2)
arrows(x0 = es$LB_delta_new_DPd_U_U_26_norm_mix_normal_base,
       x1 = es$UB_delta_new_DPd_U_U_26_norm_mix_normal_base,
       y0 = -1.2, y1 = -1.2,
       angle = 90, code = 3, length = 0.05, lty = 1, lwd = 1.5, col =  "#D2691E")
